...
@Service
public class BizAttributeAppApplicationService extends DefaultRoleBasedApplicationService<BizAttribute> {
    @Autowired
    ...
    @Override
    public BizAttributeAdminSumRep.BizAttributeCardRepresentation getEntitySumRepresentation(BizAttribute bizAttribute) {
        return new BizAttributeAdminSumRep.BizAttributeCardRepresentation(bizAttribute);
    }
